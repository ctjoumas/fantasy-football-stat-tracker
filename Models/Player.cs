namespace YahooFantasyFootball.Models
{
    ...
    public class Player
    {
        ...
        // CHECK IF POPULATED AS ITS NOT IN THE API SPEC
        ...
        // CHECK AS NOT POPULATED IN API SPEC
        ...
        [XmlElement(ElementName = "player_points", Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
    ...
    [XmlRoot(ElementName = "player_points", Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
